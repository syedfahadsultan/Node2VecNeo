...
public class Node2Vec<V, E> extends GraphVectorsImpl<V, E> {
    ...
    private class LearningCallable implements Callable<Void> {
        ...
        private GraphWalkIterator<V> iterator;

        // public void LearningCallable(){

        // }

        // public void LearningCallable(GraphWalkIterator<V> itr){
        //     this.iterator = itr;
        // }

        public void setIterator(GraphWalkIterator<V> itr){
            this.iterator = itr;
        }
